...
public class PacketEncoder<T extends PacketListener> extends MessageToByteEncoder<Packet<T>> {
    ...
    // Victus bridge (NeoForge): network filters inspect the negotiated codec while Paper keeps
    // locale propagation and oversized-packet handling in the encode path above.
