...
public class Main {
    ...
    // Victus bridge: FML launches this exact descriptor, while Paper owns option parsing and then
    // calls the OptionSet entrypoint below. Keep Paper's canonical CLI semantics instead of duplicating them.
    ...
    public static void main(final OptionSet options) { // CraftBukkit - replaces main(String[] args)
        ...
        try {
            ...
            // Victus bridge: preserve Paper's CLI/bootstrap ordering, but let NeoForge finish mod and
            // registry setup before server properties, datapacks, and Bukkit plugin loading consume it.
            ...
            // Victus bridge: retain NeoForge's path guard after Paper resolves world-container/--world.
    ...
    public static WorldLoader.DataLoadOutput<LevelDataAndDimensions.WorldDataAndGenSettings> createNewWorldData( // Paper - public
        ...
        // Victus bridge (NeoForge): round-trip Paper's selected dimensions through registry ops so
        // modded dimensions are injected on first world creation without replacing Paper world setup.
