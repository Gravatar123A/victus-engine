...
public class ServerPacksSource extends BuiltInPackSource {
    ...
    public static PackRepository createPackRepository(final Path datapackDir, final DirectoryValidator validator) {
        PackRepository packRepository = new PackRepository(
            ...
            new FolderRepositorySource(datapackDir, PackType.SERVER_DATA, PackSource.WORLD, validator)
        );
    ...
    public static PackRepository createVanillaTrustedRepository() {
        ...
        PackRepository packRepository = new PackRepository(validator, new ServerPacksSource(validator));
        // Victus bridge: reuse Paper's trusted validator for both repository construction and NeoForge's trusted finder event.
