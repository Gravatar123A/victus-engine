...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="victus-fabric-prepare-test-") as temporary:
        ...
        with zipfile.ZipFile(aggregate) as archive:
            ...
            assert remaining == ["fabric-registry-sync-v0-1.jar", "fabric-api-base-1.jar"], remaining
        ...
        print("prepare-fabric-runtime self-test: replacement ownership and remaining module set passed")
    return 0
